...
> 适用版本：V2 第二阶段正式交付版（候选 v8，`BetterUnturnedExperience.dll`，548352 字节，SHA-256 `f7b7513c…df569`，完整值见 `audit/RELEASES.md` 候选台账行 10）。
> 本手册面向玩家；开发与验收证据见 `audit/RELEASES.md` 行 9/10 所绑归档（`audit/2026-09-09/DEV-V2-24/`、`audit/2026-09-09/DEV-V2-25/`）。
