...
namespace BetterUnturnedExperience.Plugin.Tests
{
    internal static class Dev15BTests
    {
        ...
        private static void BetterItemInteractionUiComponentLifecycleAndDragFlow()
        {
            ...
            var nativeActions = new RecordingNativeDragActions();
        ...
        /// <summary>DEV-V6-04：随本套件迁入（原住 UI 套件 Program；BII 原生端口替身）。</summary>
        private sealed class RecordingNativeDragActions : INativeInventoryDragActions
        {
            ...
            internal ItemGridPosition LastSource;
            internal ItemGridPosition LastTarget;
            internal string OperationOrder = string.Empty;
